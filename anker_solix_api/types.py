...
class SolarbankTimeslot:
    ...
    allow_export: bool = None  # mapped to the turn_on boolean
    charge_priority_limit: int  = None  # mapped to charge_priority setting
...
class Solarbank2Timeslot:
    ...
    start_time: datetime
    end_time: datetime
    appliance_load: int = None  # mapped to appliance_load setting
    weekdays: set = None  # set of weekdays where this slow applies, defaulting to all if None. Sun = 0, Sat = 6
